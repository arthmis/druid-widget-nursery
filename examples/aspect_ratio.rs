...
use druid_widget_nursery::{AspectRatioBox, DynamicSizedBox};
...
fn main() {
    ...
    let aspect_ratio_message =
        "Hello there, this is a box that maintains it's aspect-ratio as best as possible.";
...
fn ui() -> impl Widget<AppState> {
    ...
    let aspect_ratio_box = AspectRatioBox::new(aspect_ratio_label, 0.8).background(Color::WHITE);
